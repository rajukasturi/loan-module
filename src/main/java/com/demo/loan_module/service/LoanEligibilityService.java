...
public interface LoanEligibilityService {
    ...
    /**
     * Determines if gold loan specific conditions are met.
     *
     * @param application The loan application
     * @return true if gold loan conditions are satisfied
     */
    boolean isGoldLoanEligible(LoanApplication application);
}
